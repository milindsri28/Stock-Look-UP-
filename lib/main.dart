      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (stock != null) ...[
              Text('Stock Symbol: ${_controller.text.toUpperCase()}'),
              Text(
                  'Current Price: \$${stock!.currentPrice.toStringAsFixed(2)}'),
              Text('High Price: \$${stock!.highPrice.toStringAsFixed(2)}'),
              Text('Low Price: \$${stock!.lowPrice.toStringAsFixed(2)}'),
              Text('Open Price: \$${stock!.openPrice.toStringAsFixed(2)}'),
              Text(
